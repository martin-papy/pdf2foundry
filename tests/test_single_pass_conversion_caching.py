"""Tests for single-pass Docling conversion and JSON caching behavior.
...
class TestSinglePassConversion:
    ...
    def test_cli_single_conversion_count_no_cache(self, monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    ...
    def test_same_docling_document_instance_used_by_both_stages(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestJSONCaching:
    ...
    def test_cache_load_avoids_conversion(self, monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    ...
    def test_ingest_docling_cache_load_avoids_conversion(self, monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    ...
    def test_convenience_mode_missing_file_converts_and_saves(self, monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    ...
    def test_write_docling_json_flag_saves_to_default_path(self, monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
...
class TestErrorHandling:
    ...
    def test_invalid_json_without_fallback_raises(self, monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    ...
    def test_invalid_json_with_fallback_converts(self, monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
        ...
        doc = ingest_docling(Path("/tmp/test.pdf"), JsonOpts(path=cache_file, fallback_on_json_failure=True))
