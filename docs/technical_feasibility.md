...
4. **Foundry document modeling (JSON)**
...
6. **Packaging to an installable compendium**
...
7. **Optional:** generate a **TOC Journal Entry** with HTML links to every Chapter/Section via `@UUID[JournalEntry.<id>.JournalEntryPage.<id>]`.
...
[9]: https://github.com/earlSt1/vtt-compendium-folders?utm_source=chatgpt.com "GitHub - earlSt1/vtt-compendium-folders: Collapsable folders in the ..."
